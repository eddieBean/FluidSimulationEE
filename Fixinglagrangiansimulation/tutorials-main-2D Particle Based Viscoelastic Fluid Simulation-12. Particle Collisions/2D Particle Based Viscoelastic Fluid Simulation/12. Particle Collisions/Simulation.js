class Simulation{
    constructor(){
        ...
        this.scene = 2; // 0: inflow, 1: dam break, 2 wheresmywater
        if (this.scene === 1){
            this.emitter = this.createParticleEmitter(
                new Vector2(canvas.width / 2, 100),  // position at top center
            ...
            let polygon = new Polygon([
                ...
                new Vector2(900,450),
                new Vector2(900,550),
                new Vector2(700,550)],"orange");

            this.shapes.push(polygon);
        }
        if (this.scene === 2){
            this.instantiateParticles(1000);
        }
    }
